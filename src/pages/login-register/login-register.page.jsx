    ...
    return (
        ...
        <div className="row btns">
            <div className="col s12 center-align">
                <Link to={`/logreg/login`} className="waves-effect waves-light btn btn-base">Login</Link>
                <Link to={`/logreg/register`} className="waves-effect waves-light btn btn-base">Register</Link>
            </div>
        </div>
            <Switch>
